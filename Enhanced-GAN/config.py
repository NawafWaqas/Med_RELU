...
SAVE_DIR = r'D:\pggan keras\trained models'  # path to save trained models
IMAGE_SAVE_DIR = r'D:\pggan keras\image save'  # path to save GAN images
SUMMARY_DIR = r'D:\pggan keras\data'

# Data Preprocessing and augmentation parameters
INPUT_SHAPE = (384, 384, 3)  # size of random crops used for training
