...
class BatchNorm2d(nn.BatchNorm2d):
    def __init__(self, num_features, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True):
        super(BatchNorm2d, self).__init__(num_features=num_features, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
...
class Conv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size,
                    ...
                    lrelu=True, weight_norm=False, bnorm=True, equalized=True):
        ...
        self.normalize = BatchNorm2d(out_channels) if bnorm else None
