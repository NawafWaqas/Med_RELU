...
class PGGAN(nn.Module):
    def __init__(self, args, device='cuda'):
        ...
        self.toRGB.append(ll.Conv2d(self.depths[0], self.img_channels, 1, lrelu=False, snorm=False)) # toRGB
    ...
    def add_scale(self, increase_idx=True):
        ...
        self.G.append(blk)
        self.toRGB.append(ll.Conv2d(self.depths[self.didx], self.img_channels, 1, lrelu=False, snorm=False)) # toRGB
